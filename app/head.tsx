...
const Head = () => {
  ...
  return (
    <>
      ...
      <meta
        property="og:url"
        content={`https://maheenakhtarkhan.vercel.app${pathname}`}
      />
      <link rel="canonical" href={`https://maheenakhtarkhan.vercel.app${pathname}`} />
      <link rel="me" href="mailto:pakhtar635@gmail.com" />
      <meta property="og:type" content={meta.type} />
      <meta property="og:site_name" content="Maheen Akhtar Khan" />
      <meta property="og:description" content={meta.description} />
      <meta property="og:title" content={meta.title} />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:site" content="@hellokittykenma" />
