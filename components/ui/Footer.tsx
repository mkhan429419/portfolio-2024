  ...
  return (
    <footer className="w-full lg:max-w-screen-md flex flex-col justify-center items-center mx-auto">
      ...
      <AnimationContainer customClassName="w-full grid place-items-center grid-cols-3 gap-1 lg:gap-4 pb-8 sm:grid-cols-3 mx-3">
        ...
        <div className="flex flex-col space-y-4">
          <ExternalLink href="https://github.com/mkhan429419">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
          ...
          <ExternalLink href="mailto:pakhtar635@gmail.com">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
              ...
              viewBox="0 0 16 16"
            >
              <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2zm13 2.383l-5.803 3.484a.5.5 0 0 1-.394 0L2 5.383V12a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V5.383z" />
            </svg>
            Gmail
          </ExternalLink>
        </div>
        ...
        <div className="flex flex-col space-y-4">
          <ExternalLink href="https://www.instagram.com/heen.666?igsh=MW9mOThkeTFhdXhibQ==">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
          ...
          <ExternalLink href="https://docs.google.com/document/d/1nIfMH813-7o8hPvigFmR_V0AGXJpW7PEWTVAOiT4Lfo/export?format=pdf">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
